    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DraftImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DraftImages_Drafts_DraftId",
                        column: x => x.DraftId,
                        principalTable: "Drafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DraftImages_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Drafts_DraftId",
                        column: x => x.DraftId,
                        principalTable: "Drafts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DraftImages_DraftId",
                table: "DraftImages",
                column: "DraftId");

            migrationBuilder.CreateIndex(
                name: "IX_DraftImages_ImageId",
                table: "DraftImages",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_Drafts_TypeId",
                table: "Drafts",
                column: "TypeId");
